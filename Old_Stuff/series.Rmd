...
link-citations: yes
github-repo: openscapes/series
description: "Manual de Graduação -- Organização Industrial."
---

# Introdução {#welcome}

Porque resolvi montar este livro:
...
Uma das coisas que fica meio confusa de se dar conta quando passamos pelos cursos de Microeconomia I e II é que, do ponto de vista da Teoria Econômica Neoclássica, podemos representar o funcionamento da firma de duas formas alternativas:
...
Podemos ver isso de forma um pouco mais intuitiva com a figura a seguir, que ilustra uma função de produção cúbica, do tipo $Q=a_{1}x +a_{2}x^2 + a_{3}x^3$. Os valores relativos de $a_{2}$ e $a_{3}$ determinam aonde os retornos crescentes e decrescentes começam.

<iframe scrolling='no' frameborder='0' src='https://www.wolframcloud.com/objects/demonstrations/ShortRunProductionAndCostCurves?_view=EMBED' style='border:0;' width= '700' height='450'></iframe>
...
[^1]: A fonte dessas demonstrações é VARIAN, Microeconomic Analysis.
...
<!--chapter:end:04-Oligopolio.Rmd-->

---
title: "Livre Entrada e Ineficiencia Social"
...
<!--chapter:end:Free_Entry_Social_Ineff.Rmd-->

---
title: "Monopólio"
author: "Claudio Lucinda"
date: "07 de março de 2019"
output: html_document
---
